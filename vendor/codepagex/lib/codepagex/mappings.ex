...
defmodule Codepagex.Mappings do
  ...
  # Modified for Elixir 1.19 compatibility: ensure MappingFile is compiled first
  @external_resource "lib/codepagex/mapping_file.ex"
  require Codepagex.MappingFile
